        ...
        <div className="flex items-center justify-center" id="image-container">
          {images.map((image, index) => (
            ...
            <button type="button" class="absolute top-0 start-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none" data-carousel-prev onClick={showPrevImage}>
                <span class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-white/60 group-hover:bg-gray-700 group-focus:ring-4 group-focus:ring-white group-focus:outline-none">
                    <svg class="w-4 h-4 text-black group-hover:text-white rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
