          ...
          <div>
            ...
            >
             ...
             <div className="flex items-center space-x-2 mt-8">
              <a href="https://wa.me/61415512800&text=" target="_blank" rel="nofollow noopener" aria-label="Whatsapp" className="flex items-center px-8 py-4 bg-teal-500 text-white rounded font-semibold" data-form="chaty-form-0-Whatsapp" data-hover="WhatsApp" data-text="Get a Quote!">
